...
import AnalyticsDashboardRoute from '@/routes/analytics-dashboard'
    ...
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/analytics/dashboard" element={<AnalyticsDashboardRoute />} />
      ...
      <Route element={<RequireAdminAuth />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path={APP_ROUTES.admin.subscriptions} element={<Navigate to={APP_ROUTES.admin.plans} replace />} />
...
function AppLanguageSync() {
  ...
  useEffect(() => {
    if (user?.settings?.language) {
      syncLanguage(user.settings.language);
    }
