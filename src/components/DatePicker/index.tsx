  ...
  return (
    <PopoverPrimitive.Root>
      ...
      >
        ...
        <span className={['flex-1 text-left', value ? 'text-neutral-900' : 'text-neutral-400'].join(' ')}>
        ...
        >
          <DayPicker
            ...
            classNames={{
              ...
              weekdays:       'flex',
              weekday:        'w-9 text-center text-[11px] font-medium uppercase tracking-wide text-neutral-400 pb-1',
              weeks:          '',
              week:           'flex mt-0.5',
              day:            'p-0',
              day_button:     '',
            ...
            components={{
              ...
              DayButton: ({ day: _day, modifiers, className: _cn, ...props }) => (
                <button
                  {...props}
                  className={[
